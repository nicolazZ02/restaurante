            ...
            <td>
                    <a href="eliminar.php?id=<?php echo $move->id_usu?> &nomb=<?php echo $move->nom_usu?> &apel=<?php echo $move->ape_usu?> &tel=<?php echo $move->tel_usu?> "><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteChildresn">
                        Eliminar
                                            ...
                                            <!-- Button trigger modal -->
                       <td> <button type="button" class="btn btn-primary editbtn" data-bs-toggle="modal" data-bs-target="#mod_per">
                       Modificar
                        </button></td>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                <h1>Modifica el cliente</h1>
                                <form action="modificar.php" method="post">
                                    <input type="hidden" name="id" id="update_id">
                                    <label for="">Cedula:</label>
                                    <input type="text" class="form-control" name="id" id="ced" readonly>
                                    <label for="">Nombre:</label>
                                    <input type="text" class="form-control" name="nomb" id="nom" >
